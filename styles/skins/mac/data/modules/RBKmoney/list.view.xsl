...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="fiscalization">
                                <xsl:choose>
                                    <xsl:when
                                            test="$fiscalization = 'RBK_MONEY_PARAMETER_NOT_USE'">
                                        <option value="RBK_MONEY_PARAMETER_USE">&RBK_MONEY_PARAMETER_USE;</option>
                                        <option selected="true"
                                                value="RBK_MONEY_PARAMETER_USE">&RBK_MONEY_PARAMETER_NOT_USE;
                                        </option>
                                    </xsl:when>
                                    <xsl:otherwise>
                                        <option value="RBK_MONEY_PARAMETER_USE">&RBK_MONEY_PARAMETER_USE;</option>
                                        <option value="RBK_MONEY_PARAMETER_NOT_USE">&RBK_MONEY_PARAMETER_NOT_USE;</option>
                                    </xsl:otherwise>
                                </xsl:choose>
                            </select>
                        </td>
    ...
    <xsl:template match="/result[@method = 'page_transactions']/data[@type = 'list' and @action = 'view']">
        ...
        <script type="text/javascript" src="/styles/skins/mac/design/js/rbkmoney.js"/>
